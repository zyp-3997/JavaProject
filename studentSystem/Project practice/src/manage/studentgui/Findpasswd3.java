...
public class Findpasswd3 extends JFrame { 
    ...
    * @param title
    */
    public Findpasswd3(String title) {
        super(title);
        // 创建学生管理应用程序
        app = new Application();
    ...
    */
    private void findpassword() {
        ...
        public int update(S_user user) {
	        ...
	        // 定义SQL字符串
	        String strSQL = "UPDATE s_user SET user_name = ?, user_password = ?, user_tel = ? WHERE user_id = ?";
        ...
        public  S_user idtel(String userid, String usertel){
    	    // 声明用户
    	   S_user user = null;
    	    // 获取数据库连接
    	    Connection conn = ConnectionManager.getConnection();
    	    // 定义SQL字符串
    	    String strSQL = "SELECT * FROM s_user WHERE user_id = ? AND user_tel = ?";
    	    try {
    	        // 创建预备语句对象
    	        PreparedStatement pstmt = conn.prepareStatement(strSQL);
    	        // 设置占位符的值
        ...
        public  S_user id(String userid){
    	    // 声明用户
    	    S_user user = null;
    	    // 获取数据库连接
    	    Connection conn = ConnectionManager.getConnection();
    	    // 定义SQL字符串
    	    String strSQL = "SELECT * FROM s_user WHERE user_id = ?";
    	    try {
    	        // 创建预备语句对象
    	        PreparedStatement pstmt = conn.prepareStatement(strSQL);
    	        // 设置占位符的值
        ...
        public static void main(String args[]){
        	Findpasswd3 findpasswd3=new Findpasswd3("新密码");
