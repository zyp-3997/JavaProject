...
public class AddTeacherInforFrame extends JFrame {
	...
	private Vector colHead;
	    ...
	    */
	    ...
	    //设置构造方法
 public AddTeacherInforFrame(String title) {
	 super(title);
	 Start();
 }
 //定义执行方法
 ...
 // p4.setLayout(new GridLayout(1,4));
  ...
  JLabel lblInputId=new JLabel("输入教师号：");
...
int count=teacherServiceImpl.addinfor(teacher);
...
if (count > 0) {
    ...
    JOptionPane.showMessageDialog(null, "教师工号只能唯一！", "警告", JOptionPane.WARNING_MESSAGE);
}
