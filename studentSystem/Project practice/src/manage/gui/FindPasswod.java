...
public class FindPasswod extends JFrame { 
    ...
    * @param title
    */
    public FindPasswod(String title) {
        super(title);
        // 创建学生管理应用程序
        app = new Application();
    ...
    */
    private void findpassword() {
        ...
        if (id(userid) == null) { 
	    	   ...
	    	   JOptionPane.showMessageDialog(null, "电话不正确，请重新输入！", "错误提示", JOptionPane.ERROR_MESSAGE);
	    	 txtTelephone.requestFocus();
        ...
        public  M_user idtel(String userid, String usertel){
    	    // 声明用户
    	    M_user user = null;
    	    // 获取数据库连接
    	    Connection conn = ConnectionManager.getConnection();
        ...
        public  M_user id(String userid){
    	    // 声明用户
    	    M_user user = null;
    	    // 获取数据库连接
    	    Connection conn = ConnectionManager.getConnection();
        ...
        public static void main(String args[]){
        	FindPasswod findPasswod=new FindPasswod("新密码");
        }
    }
