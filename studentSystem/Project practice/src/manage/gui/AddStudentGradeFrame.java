...
public class AddStudentGradeFrame extends JFrame {
	...
	private Vector colHead;
	   ...
	   Grade grade;
	    ...
	    //设置构造方法
 public AddStudentGradeFrame(String title) {
	 super(title);
	 Start();
 }
 //定义执行方法
  ...
  badd.addActionListener(new ActionListener() {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		grade.setStudent_names(nametext.getText());
		grade.setClass_names(classtext.getText());
	...
	int count=gradeServiceImpl.addgrade(grade);
